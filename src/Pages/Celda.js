...
class Celda extends Component{
    ...
    handleClick(e) {
        ...
        let dummyData = {}
        dummyData.initialDate = '05/02/2021'
        dummyData.endDate = '06/02/2021'
        dummyData.name = name
        dummyData.priority ='1'// priority
    ...
    render(){
        return(
            <th className='task' onClick = {this.handleClick}  >{this.state.name}</th>
        )
    }
}
